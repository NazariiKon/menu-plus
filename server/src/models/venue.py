...
class Venue(Base):
    ...
    google_maps_link: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)
    inst_link: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)
    facebook_link: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)
    tiktok_link: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)
    ...
    background: Mapped[str] = mapped_column(String(20), default="defaultBG.png")
