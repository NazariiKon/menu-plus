...
from src.api.dependencies import get_category_service, get_current_user, get_venue_service
from src.services.category_service import CategoryService
from src.services.venue_service import VenueService
from src.schemas.menu import CategoryCreate, CategoryRead
from fastapi import UploadFile, File, Form, HTTPException
from typing import List


router = APIRouter(prefix="/venues/{venue_id}/menus/{menu_id}", tags=["Menu"])

@router.post("/categories", response_model=List[CategoryRead], status_code=status.HTTP_201_CREATED)
